...
public class Query {
	...
	public Query(String filter, String sortField, ArrayList<TypeFilter> tfs, ArrayList<GenerationFilter> gfs,
			ArrayList<SizeFilter> sfs, ArrayList<WeightFilter> wfs) {
		this.filter = filter;
